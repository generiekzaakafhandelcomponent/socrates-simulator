...
data class StraatadresBuitenland(
    ...
    @get:JsonProperty("huisnummerBuitenland") val huisnummerBuitenland: kotlin.Int? = null,
    ...
    @get:JsonProperty("landencodeIso") val landencodeIso: String? = null,
    ...
    @get:JsonProperty("landsnaam") val landsnaam: String? = null,
    ...
    @get:JsonProperty("locatieomschrijvingBuitenland") val locatieomschrijvingBuitenland: String? = null,
    ...
    @get:JsonProperty("postcodeBuitenland") val postcodeBuitenland: String? = null,
    ...
    @get:JsonProperty("regionaamBuitenland") val regionaamBuitenland: String? = null,
    ...
    @get:JsonProperty("straatnaamBuitenland") val straatnaamBuitenland: String? = null,
    ...
    @get:JsonProperty("woonplaatsnaamBuitenland") val woonplaatsnaamBuitenland: String? = null
)
