...
data class NederlandsStraatadres(
    ...
    @get:JsonProperty("huisnummer", required = true) override val huisnummer: Int,
    ...
    @get:JsonProperty("straatnaam", required = true) override val straatnaam: String,
    ...
    @get:JsonProperty("aanduidingBijHuisnummer") override val aanduidingBijHuisnummer: String? = null,
    ...
    @get:JsonProperty("huisletter") override val huisletter: String? = null,
    ...
    @get:JsonProperty("huisnummertoevoeging") override val huisnummertoevoeging: String? = null,
